...
//    var toDoNotesArray = ["I should be certain to do all of the exercises in the chapters before the exam", "take my ideas to the school venture competition and win the big check.", "Focusa pps on empowerment for all, with an extra focus on users who are kind."]
